...
require (
	...
	github.com/JohnEarle/redisstringset v1.0.2
	...
	github.com/owasp-amass/asset-db v0.17.0
...
replace github.com/owasp-amass/amass/v4 => github.com/JohnEarle/amass-develop/v4 v4.2.2
